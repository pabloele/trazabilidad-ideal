...
//         {/* Portada */}
//         <Grid item xs={12} sx={{backgroundImage:"https://via.placeholder.com/150"}}>
...
//           <Grid container spacing={3}>
//             {/* Agrega aquí los módulos con los datos que quieras mostrar */}
//             <Grid item xs={12} md={6}>
//               <Paper elevation={3} style={{ padding: '20px' }}>
//                 {/* Contenido del módulo */}
//                 <Typography variant="h6">Módulo 1</Typography>
...
//               <Paper elevation={3} style={{ padding: '20px' }}>
//                 {/* Contenido del módulo */}
//                 <Typography variant="h6">Módulo 2</Typography>
//                 {/* Agrega más contenido según tus necesidades */}
//               </Paper>
//             </Grid>
